	...
	public function up()
	{
		...
		Schema::create('bk_transaction_history', function (Blueprint $table) {
			...
			$table->number('amount')->nullable();
			$table->integer('amount_day',256)->nullable();
			...
			$table->date('telesale_time')->nullable();
			$table->integer('saler_id')->nullable();
			$table->date('saler_time')->nullable();
